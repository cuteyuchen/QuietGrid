...
生成时间：2026-07-20T17:20:56.551830+00:00
...
| TRADED | breakout_reversal_stop_loss | 8 | -0.68 | 12.43 | -21.01 | 0.50 |
| TRADED | stop_loss | 7 | 1.84 | 3.55 | 0.00 | 0.00 |
| TRADED | stop_loss_upper | 2 | 1.57 | 1.98 | 0.00 | 0.00 |
| TRADED | breakout_reversal_stop_loss_upper | 1 | 0.09 | 0.54 | -2.32 | 0.06 |
...
| TRADED | breakout_reversal_stop_loss_upper | 1 | -3.63 | 1.55 | -2.78 | 0.07 |

## 开发集最差窗口

| 标的 | 窗口 | 原因 | 盈亏 | 全程收益 | 最大上行 | 最大下行 | 入场方向 | 方向效率 |
|---|---|---|---:|---:|---:|---:|---:|---:|
| BTCUSDT | nyse_20250108T210000Z | breakout_reversal_stop_loss | -7.74 | -0.85% | 0.33% | -4.02% | -1 | 0.137 |
| BTCUSDT | nyse_20240830T200000Z | breakout_reversal_stop_loss | -4.97 | -0.06% | 0.98% | -3.41% | 1 | 0.182 |
| BTCUSDT | nyse_20250620T200000Z | breakout_reversal_stop_loss | -4.93 | -1.31% | 0.85% | -4.64% | -1 | 0.087 |
| BTCUSDT | nyse_20241122T210000Z | stop_loss | -1.82 | -0.80% | 0.02% | -3.10% | 1 | 0.379 |
| BTCUSDT | nyse_20250307T210000Z | breakout_reversal_stop_loss | -1.72 | -5.16% | 0.12% | -7.81% | 1 | 0.144 |
...
| BTCUSDT | nyse_20250117T210000Z | breakout_reversal_stop_loss | -1.08 | -1.80% | 5.28% | -4.25% | -1 | 0.594 |
