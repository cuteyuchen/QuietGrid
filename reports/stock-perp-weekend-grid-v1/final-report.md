...
- Development 日历窗口 W/O/R：`{'W': 17, 'O': 4, 'R': 144}`
- W realized volatility 中位数：`0.02164982170394055`
- O realized volatility 中位数：`0.014062010843014928`
- R realized volatility 中位数：`0.05599161714908124`
...
失败门槛：`volatility_not_higher_than_90pct, directional_efficiency_not_higher, cycle_capacity_not_lower, sixty_percent_month_advantage, advantage_not_one_symbol, best_window_contribution_le_35pct, bootstrap_supports_non_noise, mature_stage_direction`
