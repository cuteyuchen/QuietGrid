...
- Tier A-Core：`8`
- Development W/O/R：`{'W': 103, 'O': 8, 'R': 570}`
- W realized volatility 中位数：`0.02347646026978146`
- O realized volatility 中位数：`0.014361402817617396`
- R realized volatility 中位数：`0.05359663140682248`
...
| W 成交质量不显著差于 O/R | **PASS** |

失败门槛：`volatility_not_higher_than_90pct, directional_efficiency_not_higher, cycle_capacity_not_lower, sixty_percent_month_advantage, advantage_not_one_symbol, bootstrap_supports_non_noise, mature_stage_direction, development_sample_sufficiency`
